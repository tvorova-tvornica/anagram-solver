...
namespace AnagramSolver.Data.Migrations
{
    ...
    [Migration("20230928213149_UpdateModelSnapshotToMatchNewNavigationPropertyName")]
    partial class UpdateModelSnapshotToMatchNewNavigationPropertyName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnagramSolver.Data.Entities.Celebrity", b =>
                {
                    ...
                    b.HasIndex("HrAnagramKey");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("HrAnagramKey"), "hash");
            ...
            modelBuilder.Entity("AnagramSolver.Data.Entities.ImportWikiDataCelebritiesRequest", b =>
                {
                    b.Navigation("ImportPageRequests");
                });
